...
public class StudentEvalRecordController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("eval:studentevalrecord:list")
    ...
    @RequiresPermissions("eval:studentevalrecord:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("eval:studentevalrecord:save")
    ...
    @RequiresPermissions("eval:studentevalrecord:update")
    ...
    @RequiresPermissions("eval:studentevalrecord:delete")
