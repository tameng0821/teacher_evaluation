...
public class SysDeptController extends AbstractController {
	...
	public Response info(){
		...
		return Response.ok().put("deptId", deptId);
	}
	...
	public Response info(@PathVariable("deptId") Long deptId){
		SysDeptEntity dept = sysDeptService.getById(deptId);
		
		return Response.ok().put("dept", dept);
	}
	...
	public Response save(@RequestBody SysDeptEntity dept){
	...
	public Response update(@RequestBody SysDeptEntity dept){
	...
	public Response delete(long deptId){
		//判断是否有子部门
