 ...
 */
@Mapper
public interface ColleagueEvalTaskDao extends BaseMapper<ColleagueEvalTaskEntity> {
     ...
     * @return 查询结果
     */
    List<ColleagueEvalTaskEntity> pageGetList(IPage<ColleagueEvalTaskEntity> page, Integer evalTaskStatus,String sql_filter);
